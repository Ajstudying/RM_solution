...
public interface CompanyMapper {
    //회사 정보 추가
    @Insert("INSERT INTO company (company_name, company_telephone, company_mail, company_address, storage_capacity) " +
            "VALUES (#{companyName}, #{companyTelephone}, #{companyMail}, #{companyAddress}, #{storageCapacity})")
